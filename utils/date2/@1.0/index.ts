...
class Date2Class {
   ...
   */
  addSeconds(s: number) {
    return this.addMilliSeconds(1000 * s);
  }
  ...
  addMinutes(min: number) {
    return this.addMilliSeconds(60 * 1000 * min);
  }
   ...
   */
  addHours(h: number) {
    return this.addMilliSeconds(3600 * 1000 * h);
  }
   ...
   */
  addDays(d: number) {
    return this.addMilliSeconds(24 * 3600 * 1000 * d);
  }
